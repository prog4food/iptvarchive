...
description = Pure python implementation xxhash algorithms
long_description = file: README.rst
long_description_content_type = text/x-rst
url = https://github.com/vgbundo/ppxxh

363de45, small fixes by prog4dood
"""
import struct
...
class xxh32:
    ...
    def _r(x, bits):
        ...
        return ((x << bits) | (x >> (32 - bits))) & xxh32._M32
    ...
    def intdigest(self):
        ...
        for b in tmpbuffer:
            output = (
                self._r((output + ord(b) * self._P5) & self._M32, 11) * self._P1
            ) & self._M32
